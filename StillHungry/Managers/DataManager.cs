...
namespace StillHungry.Managers
{
    ...
    public class DataManager
    {
        ...
        public static Dictionary<EMonsterType, MonsterStat> MonsterStatDict { get; private set; } = new Dictionary<EMonsterType, MonsterStat>();
        ...
        public static void LoadGameData()
        {
            ...
            MonsterStatDict = LoadJson<MonsterStatLoader, EMonsterType, MonsterStat>("GameData/MonsterStat").MakeData();
